    ...
    return(
        <div>
            ...
            <div class="search">
                ...
                <input type="search" class="light-table-filter" name="search" data-table="order-table" id="search" placeholder=" Buscar por Nombre, Email o Palabra clave..."/>
            </div>
            
            <input type="button" value="+ Añadir alumnos"/>
            </nav>
            <div className='container__excel'>
                <table class="excel order-table table">
                <thead>
                    <tr>
                        <th class="sortable">Nombre <i class="fas fa-sort"></i></th>
                        <th>Ciudad <i class="fas fa-sort"></i></th>
                        <th>País <i class="fas fa-sort"></i></th>
                        <th>Teléfono</th>
                        <th>Correo Electrónico <i class="fas fa-sort"></i></th>
                        <th>Etiquetas <i class="fas fa-sort"></i></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
